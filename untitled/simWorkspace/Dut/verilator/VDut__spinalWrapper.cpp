...
public:
    ...
    Wrapper_1(const char * name){
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("C:\\Users\\Administrator\\Desktop\\spinalhdl_coding\\untitled\\.\\simWorkspace\\Dut/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("C:\\Users\\Administrator\\Desktop\\spinalhdl_coding\\untitled\\.\\simWorkspace\\Dut/") + name + ".dat").c_str());
      #endif
    }
